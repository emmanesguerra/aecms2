                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-row">
                                <div  class="form-group  col-sm-12">
                                    ...
                                    <input maxlength="50" type="text" class="form-control ae-input-field @error('marker') is-invalid @enderror " name="marker" value="{{ old('marker') }}" id="marker" placeholder="Marker"/>
                                    ...
                                    <div class="alert alert-info" role="alert">
                                        ...
                                        <ol>
                                            ...
                                            <li>Search the address</li>
                                            <li>Click the share button</li>
                                            <li>Click the copy link</li>
                                            <li>Paste the copied link to the input field above</li>
                                        </ol>
                                    </div>
                                 </div>
                            </div>
                            <div class="form-row">
                                ...
                                @error('store_hours') <div class="invalid-feedback">{{ $message }}</div> @enderror 
                            </div>
                        </div>
                    </div>
