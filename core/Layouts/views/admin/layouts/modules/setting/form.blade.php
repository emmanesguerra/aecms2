...
<section class="main-panel">
    <div class="row">
        <div class="card" style="width: 100%">
            ...
            <div class="card-body">
                <form autocomplete="off" id="settingsform" action="{{ route('setting.store') }}" method="post">
                    @csrf
                    <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-row">
                                    <div  class="custom-control form-group  col-sm-12">
                                        ...
                                        <input type="text" class="form-control ae-input-field @error('domain_name') is-invalid @enderror " name="domain_name" value="{{ old('domain_name', $data['model']['domain_name']) }}" id="domain_name" placeholder="ex. your.website.com">
                                ...
                                <div class="form-row">
                                    <div  class="form-group  col-sm-12">
                                        ...
                                        <input type="text" class="form-control ae-input-field @error('website_name') is-invalid @enderror " name="website_name" value="{{ old('website_name', $data['model']['website_name']) }}" id="website_name" placeholder="ex. Your Website">
                                ...
                                <div class="form-row">
                                    <div  class="form-group  col-sm-12">
                                        ...
                                        <input type="text" class="form-control ae-input-field @error('owner') is-invalid @enderror " name="owner" value="{{ old('owner', $data['model']['owner']) }}" id="owner" placeholder="Owner's name">
                                ...
                                <div class="form-row">
                                    <div  class="form-group  col-sm-12">
                                        ...
                                        <input type="text" class="form-control ae-input-field @error('meta_title') is-invalid @enderror " name="meta_title" value="{{ old('meta_title', $data['model']['meta_title']) }}" id="meta_title" placeholder="Default page title">
                                ...
                                <div class="form-row">
                                    <div  class="form-group  col-sm-12">
                                        ...
                                        <textarea  class="form-control ae-input-field @error('meta_description') is-invalid @enderror " name="meta_description" id="meta_description" placeholder="Default page description" rows="5">{{ old('meta_description', $data['model']['meta_description']) }}</textarea>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-row">
                                    <div  class="form-group  col-sm-12">
                                        ...
                                        <input type="text" class="form-control ae-input-field @error('developer') is-invalid @enderror " name="developer" value="{{ old('developer', $data['model']['developer']) }}" id="developer" placeholder="Developer's name">
